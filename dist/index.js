module.exports = (() => {
  var __webpack_modules__ = {
    456: (e, t, r) => {
      ...
      const o = r(134);
      const n = () => {
        const e = JSON.stringify(o.context.payload, undefined, 2);
        console.log(`The event payload: ${e}`);
      };
      n();
    },
    604: function (e, t, r) {
    ...
    134: function (e, t, r) {
      ...
      var n =
        ...
        function (e) {
          ...
          var t = {};
          if (e != null)
            for (var r in e) if (Object.hasOwnProperty.call(e, r)) s(t, e, r);
          o(t, e);
          return t;
        };
      Object.defineProperty(t, "__esModule", { value: true });
    ...
    310: function (e, t, r) {
      ...
      const d = { baseUrl: l, request: { agent: c.getProxyAgent(l) } };
    ...
    840: (e, t, r) => {
      ...
      const d = [a.BadGateway, a.ServiceUnavailable, a.GatewayTimeout];
      ...
      class HttpClient {
        ...
        async request(e, t, r, o) {
          ...
          let c =
            this._allowRetries && m.indexOf(e) != -1 ? this._maxRetries + 1 : 1;
          let u = 0;
          let p;
          while (u < c) {
            p = await this.requestRaw(i, r);
            if (p && p.message && p.message.statusCode === a.Unauthorized) {
              let e;
              for (let t = 0; t < this.handlers.length; t++) {
                if (this.handlers[t].canHandleAuthentication(p)) {
                  e = this.handlers[t];
                  break;
                }
              }
            ...
            while (
              l.indexOf(p.message.statusCode) != -1 &&
              this._allowRedirects &&
              t > 0
            ) {
              const c = p.message.headers["location"];
              if (!c) {
                break;
              }
              let a = s.parse(c);
              ...
              i = this._prepareRequest(e, a, o);
              p = await this.requestRaw(i, r);
              t--;
            }
            if (d.indexOf(p.message.statusCode) == -1) {
              return p;
            }
            u += 1;
            if (u < c) {
        ...
        _prepareRequest(e, t, r) {
          ...
          s.options.port = s.parsedUrl.port ? parseInt(s.parsedUrl.port) : c;
          s.options.path =
        ...
        _getAgent(e) {
          ...
          if (!!this.requestOptions) {
            p = this.requestOptions.maxSockets || o.globalAgent.maxSockets;
          }
          if (a) {
            if (!c) {
              c = r(265);
            ...
            const e = {
              ...
              proxy: { proxyAuth: s.auth, host: s.hostname, port: s.port },
            };
            let o;
            const n = s.protocol === "https:";
            if (u) {
              o = n ? c.httpsOverHttps : c.httpsOverHttp;
            } else {
              o = n ? c.httpOverHttps : c.httpOverHttp;
            }
            t = o(e);
            this._proxyAgent = t;
          }
          if (this._keepAlive && !t) {
            ...
            t = u ? new n.Agent(e) : new o.Agent(e);
            this._agent = t;
          }
          if (!t) {
            t = u ? n.globalAgent : o.globalAgent;
          }
          ...
          this.graphql = i
            ...
            .defaults(
              _objectSpread2(
                _objectSpread2({}, r),
                {},
                { baseUrl: r.baseUrl.replace(/\/api\/v3$/, "/api") }
              )
            );
        ...
        return {
          [Symbol.asyncIterator]: () => ({
            next() {
              ...
              return o({ method: n, url: c, headers: i })
                .then(normalizePaginatedListResponse)
                .then((e) => {
                  c = ((e.headers.link || "").match(
                    /<([^>]+)>;\s*rel="next"/
                  ) || [])[1];
                  return { value: e };
                });
      ...
      function endpointsToMethods(e, t) {
        ...
        for (const [s, o] of Object.entries(t)) {
          for (const [t, n] of Object.entries(o)) {
            const [o, i, c] = n;
            const [a, u] = o.split(/ /);
            const p = Object.assign({ method: a, url: u }, i);
            if (!r[s]) {
              r[s] = {};
            }
            const l = r[s];
            if (c) {
              l[t] = decorate(e, s, t, p, c);
              continue;
            }
          ...
          .then((o) => {
            ...
            if (r >= 400) {
              return o.text().then((s) => {
                const o = new c.RequestError(s, r, { headers: t, request: e });
                try {
                  let e = JSON.parse(o.message);
                  Object.assign(o, e);
                  let t = e.errors;
                  o.message =
                    o.message + ": " + t.map(JSON.stringify).join(", ");
                } catch (e) {}
                throw o;
              });
            }
    ...
    534: (e, t, r) => {
      ...
      function fetch(e, t) {
        ...
        return new fetch.Promise(function (r, n) {
          ...
          function finalize() {
            g.abort();
            if (l) l.removeEventListener("abort", f);
            clearTimeout(h);
          }
          if (a.timeout) {
          ...
          g.on("response", function (e) {
            ...
            const u = { flush: c.Z_SYNC_FLUSH, finishFlush: c.Z_SYNC_FLUSH };
            if (i == "gzip" || i == "x-gzip") {
    ...
    686: (e, t, r) => {
      ...
      TunnelingAgent.prototype.addRequest = function addRequest(e, t, r, s) {
        var o = this;
        var n = mergeOptions({ request: e }, o.options, toOptions(t, r, s));
